...
// Enable ODT data termination
    ...
    REG32(0xF4CA0184) = 0x000000bd; //setting it to 34 ohm output driver resistance. register zq0cr1. odt(bits 7 to 4) set to 40 ohm.
    REG32(0xF4CA0194) = 0x000000bd; //setting it to 34 ohm output driver resistance. register zq1cr1. odt(bits 7 to 4) set to 40 ohm.
    REG32(0xF4CA01A4) = 0x000000bd; //setting it to 34 ohm output driver resistance. odt(bits 7 to 4) set to 40 ohm.
    REG32(0xF4CA01B4) = 0x000000bd; //setting it to 34 ohm output driver resistance. odt(bits 7 to 4) set to 40 ohm. for odt, b is better in old board and 3 is better in new boad.

    //7->4 ODT 3=120 ohm, 7=60 ohm, b=40 ohm
    //3->0 output impedance b=40 ohm, d=34 ohm.
    ...
    REG32(0xF4CA0004) = 0x0000ff81; //no read data eye training
