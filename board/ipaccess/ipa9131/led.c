 ...
 * the ipa9131 board, as they are based on more generalised functions for LEDs which
 * support more than 3 colours, but for which not all LEDs offer the same colours.
 * A few simplifications have been made because ipa9131 has 3 identical controllable LEDs,
 * NWK, SVC and GPS all have red and green, and yellow options, the last being formed
 * (a little unconvincingly) when both red and green segments are lit together.
 */
...
#define LED_NWK_GREEN_GPIO          88
#define LED_NWK_RED_INDEX           1
#define LED_NWK_RED_GPIO            21

/* LED_SVC */
#define LED_SVC_GREEN_INDEX         2
#define LED_SVC_GREEN_GPIO          86
#define LED_SVC_RED_INDEX           3
#define LED_SVC_RED_GPIO            87

/* LED_GPS */
#define LED_GPS_GREEN_INDEX         4
#define LED_GPS_GREEN_GPIO          22
#define LED_GPS_RED_INDEX           5
#define LED_GPS_RED_GPIO            23
...
"    ledc gps svc off                               Turn gps and service leds off (order doesn't matter)\n"
...
{
    cli_simple_run_command("ledc all red green yellow off 1 500", 0);
}
