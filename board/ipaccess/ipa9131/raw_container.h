...
#define RAW_CONTAINER_TAG_OTPMK UINT16_C(0xef07)
#define RAW_CONTAINER_TAG_JTAG_DBG_RSP UINT16_C(0xef08)
#define RAW_CONTAINER_TAG_REC_ART_SIG_DATA UINT16_C(0xef09)
