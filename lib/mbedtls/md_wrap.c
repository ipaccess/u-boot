...
{
    sha1_starts_mbed( (sha1_context *) ctx );
}

static void sha1_update_wrap( void *ctx, const unsigned char *input,
                              size_t ilen )
{
    sha1_update_mbed( (sha1_context *) ctx, input, ilen );
}

static void sha1_finish_wrap( void *ctx, unsigned char *output )
{
    sha1_finish_mbed( (sha1_context *) ctx, output );
}
...
{
    sha256_starts_mbed( (sha256_context *) ctx, 1 );
}

static void sha224_update_wrap( void *ctx, const unsigned char *input,
                                size_t ilen )
{
    sha256_update_mbed( (sha256_context *) ctx, input, ilen );
}

static void sha224_finish_wrap( void *ctx, unsigned char *output )
{
    sha256_finish_mbed( (sha256_context *) ctx, output );
}
...
{
    sha256_starts_mbed( (sha256_context *) ctx, 0 );
}
